Ki67_counter MATLAB Python Package
...
2. Installing the Ki67_counter Package

A. Change to the directory that contains the file setup.py and the subdirectory 
Ki67_counter. If you do not have write permissions, copy all its contents to a temporary 
...
3. Using the Ki67_counter Package

The Ki67_counter package is on your Python path. To import it into a Python script or 
session, execute:
